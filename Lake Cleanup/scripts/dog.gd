...
## then the orange, the tan-and-white and the dark brown — four breeds for a pack of four,
## no two alike — the same on every save, and
...
func _go_fetch(delta: float) -> void:
	...
	if (
		...
		# Somebody else got there first — the net, or another dog. A dog that
