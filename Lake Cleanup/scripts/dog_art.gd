...
##
## Four breeds since 2026-09-22 (Richard's pick off the Pixel Dogs pack): one cut sheet and
...
## — the shop head, the HUD button — draws what it always did. The pack hands them out in order — see `Dog.breed`.
##
...
## The cut sheets, by breed. tools/slice_dog.gd writes them. Index 0 is the yellow dog the
## game always had; one breed a slot, so a full pack of four is four different dogs.
const BREEDS := [22, 2, 20, 14]
