...
##
## Four breeds (2026-09-22, Richard's pick off `tools/last_dog_pack.png`): 22 the yellow
## dog the game always had, 02 the orange, 20 the tan-and-white, 14 the dark brown — one a
## slot, so a full pack is four different dogs (Richard: three would repeat one). One json each,
